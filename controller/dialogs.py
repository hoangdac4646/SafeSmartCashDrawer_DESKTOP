...
from controller.list_items import (
            ...
            self.simple_dialog = MDDialog(
                ...
                items=[
                    KitchenSinkOneLineLeftAvatarItem(
                        ...
                        source=f"{os.environ['APP_ASSETS']}heattheatr.png",
                    ),
                    KitchenSinkOneLineLeftAvatarItem(
                        text="user02@gmail.com",
                        source=f"{os.environ['APP_ASSETS']}mountaino.png",
                    ),
                    KitchenSinkOneLineLeftAvatarItem(
                        text="Add account",
                        source=f"{os.environ['APP_ASSETS']}twitter-round.png",
                    ),
                ],
            )
